...
analyst_agent = Agent(
    ...
    instruction="""
      ...
      - The visuals generated by data_visualization_agent will be automatically sent to the user, so do not worry about being unable to display it.


      # Sub-agent Interaction Guidelines
      ## sql_query_agent:
      - You must provide the tool with the ID of the business as it was recorded in the database
